        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 sm:mb-12">
              <StaggerItem>
                <Link href="/vuyela-logistics">
                  <motion.div 
                    className="group relative bg-white border border-gray-200 rounded-2xl p-6 lg:p-8 h-full transition-all duration-300 hover:shadow-2xl hover:border-yellow-400/50 hover:-translate-y-1 cursor-pointer"
                    whileHover={{ y: -4 }}
                  >
                ...
                <div className="max-w-4xl mx-auto text-center">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                    <div className="text-center">
                      <div className="text-3xl font-serif font-bold text-amber-700 mb-2">98.5%</div>
                      <div className="text-sm text-gray-600">On-Time-In-Full</div>
                    </div>
                    <div className="text-center">
                      <div className="text-3xl font-serif font-bold text-amber-700 mb-2">300+</div>
                      <div className="text-sm text-gray-600">Monthly Loads</div>
                    </div>
                    <div className="text-center">
                      <div className="text-3xl font-serif font-bold text-amber-700 mb-2">60+</div>
