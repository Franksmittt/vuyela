              ...
              <StaggerItem key={member.name}>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <p className="text-yellow-400 font-semibold text-center mb-6">{member.role}</p>
                    {member.description && (
              ...
              <StaggerItem key={member.name}>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <p className="text-yellow-400 font-semibold text-sm text-center mb-4">{member.role}</p>
